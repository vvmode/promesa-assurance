        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Link to="/local-councils" className="text-sm text-primary-foreground/70 hover:text-gold transition-colors"><Link to="/local-councils" className="text-sm text-primary-foreground/70 hover:text-gold transition-colors">Services for Local Councils</Link></Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-primary-foreground/70">Ma. Eynaaz, K. Male'</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-gold shrink-0" />
                <span className="text-sm text-primary-foreground/70">+960 7798858</span>
              </div>
              <div className="flex items-center gap-3">
